                ...
                <div className="py-12 md:py-20">
                    ...
                    <div className="pb-16 md:pb-20">
                        <div className="text-center">
                            <div className="inline-flex relative rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:bg-linear-to-b before:from-green-900 before:to-green-700/50 before:blur-3xl before:animate-pulse-slow after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,var(--color-green-500),transparent)]">
                                <Image
