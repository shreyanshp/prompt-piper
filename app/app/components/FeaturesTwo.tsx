...
const features = [
    ...
    {
        icon: (
            <svg className="fill-green-500" xmlns="http://www.w3.org/2000/svg" width="16" height="12">
    ...
    return (
        <section className="relative">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10" aria-hidden="true">
                <div className="w-80 h-80 rounded-full bg-linear-to-tr from-green-500 to-gray-900 opacity-40 blur-[160px] will-change-[filter]"></div>
            </div>
                ...
                <div className="py-12 md:py-20 pb-0 md:pb-0">
                    ...
                    <div className="group relative w-full max-w-[500px] mx-auto flex justify-center mb-32 md:mb-36">
                        <div className="absolute bottom-0 -z-10" aria-hidden="true">
                            <div className="w-80 h-80 rounded-full bg-green-500 opacity-70 blur-[160px] will-change-[filter]"></div>
                        </div>
                    ...
                    {/* Features Grid */}
                    <div className="grid lg:grid-cols-3 overflow-hidden border-y [border-image:linear-gradient(to_right,transparent,var(--color-slate-200),transparent)1] dark:[border-image:linear-gradient(to_right,transparent,var(--color-gray-600),transparent)1] *:p-6 md:*:px-10 md:*:py-12 *:relative *:before:absolute *:before:bg-linear-to-b *:before:from-transparent *:before:via-gray-200 dark:*:before:via-gray-900 *:before:[block-size:100%] *:before:[inline-size:1px] *:before:[inset-inline-start:-1px] *:before:[inset-block-start:0]">
